    ...
    <div class="main-header">
      <div class="control-header">
        <div class="header">
          ...
          <div class="desc">
            <p class="desc-title">
              در ویولیش بلاگ قصد ما بر این است تا با گردآوری بروز ترین مطالب در
              خصوص فضای گسترده اینترنت و نحوه ورود به این حوزه راهنمای کوچکی
              برای شما عزیزان بوده باشیم.
            </p>
          </div>
        </div>
      </div>
...
header {
  background-color: rgb(161, 102, 190);
  position: relative;
  top: 15rem;
  z-index: 100;
}
